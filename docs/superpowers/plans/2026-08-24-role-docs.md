...
diff <(grep -A1 '^- \*\*Backend:\*\*' docs/roles/frontend.md | grep -oE '`[A-Z]+ /[a-z_/:.]+`') <(grep -oE '^- `[A-Z]+ /[a-z_/:.]+`' docs/roles/backend.md | tr -d '- ')
echo "--- Backend <-> Database tables ---"
diff <(grep -oE '^- `[a-z_]+\(' docs/roles/backend.md | tr -d '- `(') <(grep -oE '^- `[a-z_]+\(' docs/roles/database.md | tr -d '- `(')
echo "--- Backend <-> Multi-Agent functions ---"
diff <(grep -A1 '^- \*\*Multi-Agent:\*\*' docs/roles/backend.md | grep -oE '`[a-zA-Z]+\(') <(grep -oE '^- `[a-zA-Z]+\(' docs/roles/multi-agent.md | tr -d '- ')
